...
python tests/general_benchmark.py --timing_mode ideal --target default --total_requests 1000 --output_file batchedIdeal2
python tests/general_benchmark.py --timing_mode poisson --target default --total_requests 1000 --output_file batchedRealistic2
